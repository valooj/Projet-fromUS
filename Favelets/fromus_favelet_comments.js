		...
		case "www.beallsflorida.com":
			{
				...
				fromus_imgtmp					=	document.getElementById("flyoutZoomView").innerHTML;
				fromus_imgtmp					+=	'';		
				fromus_img						= 	/(s7d5\.scene7\.com)(.*)(jpg|png|gif)/gi.exec(fromus_imgtmp)[0];	
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		case "www.indianmotorcycle.com":
			...
			if(document.getElementById("indian-model-overview-image")!=undefined)
				...
				{	// S'il s'agit d'une page produit et THEORIQUEMENT d'une preview, mais le code ne fonctionne pas dans ce cas (chrome, 03/05/13)
