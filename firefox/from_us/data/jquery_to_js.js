...
.ui-toto-widget button{
	'background-color': '#203064',
	color: 'white',
}
$('.ui-toto-widget-content').css({
	border: '1px solid #aaaaaa',
	background: 'white url(chrome-extension://__MSG_@@extension_id__/jquery/images/ui-toto-bg_flat_75_ffffff_40x100.png) 50% 50% repeat-x',
	color: '#222222',
}
...
$('.ui-toto-widget-header .ui-toto-state-highlight').css({
	...
	background: '#fbf9ee url(chrome-extension://__MSG_@@extension_id__/jquery/images/ui-toto-bg_glass_55_fbf9ee_1x400.png) 50% 50% repeat-x',
	color: '#363636',
}
...
$('.ui-toto-widget-header .ui-toto-state-error').css({
	...
	background: '#fef1ec url(chrome-extension://__MSG_@@extension_id__/jquery/images/ui-toto-bg_glass_95_fef1ec_1x400.png) 50% 50% repeat-x',
	color: '#cd0a0a',
}
...
$('.ui-toto-widget-content .ui-toto-icon').css({
	'background-image': 'url(chrome-extension://__MSG_@@extension_id__/jquery/images/ui-toto-icons_cd0a0a_256x240.png)',
}
...
/* Overlays */
$('.ui-toto-widget-overlay').css({
	background: '#aaaaaa url(chrome-extension://__MSG_@@extension_id__/jquery/images/ui-toto-bg_flat_0_aaaaaa_40x100.png) 50% 50% repeat-x',
	opacity: '.3',
