...
function create_hash($password)
{
    ...
    $salt = "fromus@68";
	//base64_encode(mcrypt_create_iv(PBKDF2_SALT_BYTES, MCRYPT_DEV_URANDOM));
...
{    
	...
	$version = 50.0; // Version de l'API  
	$user = 'vendeur_api1.from-us.com'; // Utilisateur API    
	$pass = '1369745875'; // Mot de passe API    
	$signature = 'AX-ItKzRBUx1OSBkM5LU3pNsbupeAZNAgiGWs-CWoXbS3do8dI8tuQoz'; // Signature de l'API     
