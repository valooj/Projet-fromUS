...
{ var target = event.target || event.srcElement;
	...
	if(fromus_idmatch !=undefined)
	{
		if(fromus_classmatch !=undefined)
		{
			...
			console.log('fromus_sitelist[\''+fromus_site+'\'].img_id.push(\''+fromus_selectedTexttmp+'\');');
			
			fromus_selectedTexttmp	=	fromus_classmatch[0].substring(7,fromus_classmatch[0].length-1);			
			console.log('fromus_sitelist[\''+fromus_site+'\'].img_class.push(\''+fromus_selectedTexttmp+'\');');
